...
const NoticeBarSpeakerIcon = () => {
  return (
    <svg
      className="svg-icon icon-noticeBarSpeaker w-4 text-red-500"
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor="var(--blackGoldN,var(--main-color))" />
          <stop offset="0.74876" stopColor="var(--main-color)" />
        </linearGradient>
        <linearGradient
...
export default NoticeBarSpeakerIcon;
