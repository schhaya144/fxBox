...
const GoogleIcon = () => {
  return (
    <svg
      ...
      viewBox="0 0 112 112"
      className="w-12 h-12 mx-auto my-auto" // Centering the SVG with margin auto
      fill="none"
    >
      ...
      {/* Outer ring with a different shape and color */}
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      {/* Horizontal red rectangle in the center */}
      <rect
        x="53.0547"
        y="45.0547"
        width="27.7037"
      ...
      {/* Drop shadow filter for the background */}
      <defs>
        <filter
