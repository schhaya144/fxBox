...
const RebateRatioIcon = () => {
  return (
    <svg
      className="svg-icon icon-rebateRatio text-fxbt-blue w-10 h-10" // Apply Tailwind class for color
    ...
    >
      <path
        ...
        fill="currentColor" // Use currentColor for fill color
...
export default RebateRatioIcon;
