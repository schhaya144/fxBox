...
const ChooseDateModal = ({ initialDate, onDateConfirm }) => {
  ...
  return (
    <div>
      ...
      <div
        className="bg-gray-200 rounded-lg p-2 mx-3 mt-3"
        onClick={handleToggleModal}
      >
        <div className="flex justify-between cursor-pointer  bg-gray-200 p-1">
          <h4>{confirmedDate}</h4>
            ...
            {[
              ...
              <div
                ...
                className={`text-lg transition-all duration-300 ease-in-out transform ${
                  ...
                  !isDateValid(year, selectedDate.month, selectedDate.day)
                    ? 'opacity-0 cursor-not-allowed '
                    : ''
                }`}
                onClick={() =>
                  isDateValid(year, selectedDate.month, selectedDate.day) &&
                  handleSelectDate('year', year)
                }
              >
                {year}
              </div>
                ...
                <div
                  ...
                  onClick={() =>
                    isDateValid(
                      ...
                      selectedDate.month,
                      displayedDay
                    ) && handleSelectDate('day', displayedDay)
                  }
                >
