...
const PramotionData = () => {
  return (
    <div className="commission bg-gray-200 rounded-lg mx-4 p-2 mb-16">
      <div className="commission__title flex items-center">
        <svg
          className="svg-icon icon-promotionData w-6 h-6 text-fxbt-blue"
        ...
        <span className="text-lg font-semibold ps-2">Promotion Data</span>
      </div>

      <div className="flex justify-between mt-4">
  <div className="commission__body flex-1">
    <div className="text-center border-r-2 ">
      <div className=" ">0</div>
      <div className="text-12px text-gray-500">This Week</div>
    </div>

    <div className="text-center  border-r-2 mt-3">
      <div className=" ">0</div>
      <div className="text-12px text-gray-500">Total Commission</div>
    </div>
  </div>
  ...
  <div className="commission__body flex-1 ">
    <div className="text-center ">
      <div className="">0</div>
      <div className="text-12px text-gray-500">Direct Subordinate</div>
    </div>
